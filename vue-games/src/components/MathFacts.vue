<template>
  <main id="main-container">
    <div v-if="screen === 'config'" id="config-container" class="col-5 mx-auto" style="background-color: rgb(5,15,20);">
      <h1 class="text-center text-light mb-3" style="color: white">Math Facts</h1>
